...
<script setup >
    ...
    const register = () => {
        ...
        let users = getUsers();
        let email = users.find( u => u.email == form.email);
        let password = users.find( u => u.password == form.password);
                        ...
                        <form action="">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <RouterLink class="redirect_link" to="/register">If You Dont Have Account ?</RouterLink>
                                </div>
                            </div>
